...
DIST_URI=https://github.com/tarides/opam-repository/raw/master/packages/okra
...
dune-release opam pkg \
  --dist-uri $DIST_URI/okra.$VERSION/okra-$VERSION.tbz \
  $DRY_RUN

cp -R _build/okra.$VERSION $LOCAL_REPO/packages/okra
cp $TARBALL $LOCAL_REPO/packages/okra/okra.$VERSION
